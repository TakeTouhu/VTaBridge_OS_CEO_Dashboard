...
| メール(AI Mail Manager) | 受信メールのAI振り分け(見積依頼/契約相談/質問/クレーム/請求・支払い/開発相談/日程調整/広告・不要メール/雑談/その他 — カテゴリは設定で追加可)・**4段階の緊急度判定(🔴至急/🟠高/🟡中/🟢低)**・要約・**過去のやり取りと案件情報を踏まえたAI返信ドラフト**・返信漏れ監視・**案件への自動紐付け** |
